...
public class CacheConfiguration {
        ...
        log.info("Defining Infinispan Global Configuration");
            if (this.registration == null) { // if registry is not defined, use native discovery
                ...
                return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-user-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(com.exc.domain.UserInfo.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.UserInfo.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.UserInfo.class.getName() + ".wallets", new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.UserInfo.class.getName() + ".wallets").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.KYC.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.KYC.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.Wallet.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.Wallet.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
